...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = "https://github.com/TopSkyWeb/authorizing-center"
  spec.license       = "MIT"
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/TopSkyWeb/authorizing-center"
  else
  ...
  spec.add_development_dependency "symmetric-encryption", "~> 4.3.0"
end
